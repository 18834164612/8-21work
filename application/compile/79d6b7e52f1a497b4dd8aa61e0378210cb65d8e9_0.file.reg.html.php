...
function content_5f400537f0b405_75561022 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form style="height: 300px" class="form-horizontal" action="/server/mvc-test/index.php/admin/reg/addUser" method="post">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10" >
            ...
            <a href="/server/mvc-test/index.php/admin/index/login" class="btn btn-default">登录</a>
        </div>
    </div>
</form>
</body>
